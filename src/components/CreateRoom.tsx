  ...
  return (
    <div className="bg-[var(--bg-card)] rounded-xl p-5 sm:p-6 shadow-[var(--shadow-elevated)] border border-[var(--border-subtle)]">
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 p-1 bg-[var(--bg-surface)] rounded-lg border border-[var(--border-subtle)]">
            <button
              ...
              className={`py-2.5 px-3 rounded-md font-medium transition-all duration-200 text-xs sm:text-sm ${
                videoType === 'youtube'
            ...
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 inline-block mr-1 sm:mr-1.5 -mt-0.5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button
              ...
              style={{ fontFamily: 'var(--font-body)' }}
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 inline-block mr-1 sm:mr-1.5 -mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        {/* Error */}
        {error && (
          <div className="bg-[var(--accent-warm)]/10 border border-[var(--accent-warm)]/30 text-[var(--accent-warm)] px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg text-xs sm:text-sm" style={{ fontFamily: 'var(--font-body)' }}>
            {error}
          </div>
        )}
